...
export function Card({ lineCode, lineColor, situation, status, description, onOpenHistory }: Props) {
    return (
        <div
        ...
        >
            ...
            <div>
                <div className="flex gap-1 items-center">
                    <div className={`h-2 w-2 rounded-full ${status ? STATUS_DOT[status] : "bg-gray-600"}`} />
